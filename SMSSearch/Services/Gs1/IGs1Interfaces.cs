...
namespace SMS_Search.Services.Gs1
{
    ...
    public interface IGs1BarcodeService
    {
        ...
        void SaveAsPdf(string barcodeData, Gs1BarcodeType type, string filePath, bool includeDetails = false, List<Gs1ParsedAi>? parsedAis = null, string? barcodeName = null, string? barcodeDescription = null);
